...
class ArticleController extends Controller
{
    ...
    public function create()
    {
        ...
        $contentName4 = array( 0 => 'Select Sub Category');
        $title = 'Article';
        $custom_cat = 'articles';
        ...
        return view('admin.backend.articles.article.articleForm',compact('title','contentName','contentName2','contentName3','contentName4','custom_cat'));
    }
    ...
    public function edit($id)
    {
        ...
        foreach ($subcategories as $subCategorie)   
            $contentName4[$subCategorie->id] = $subCategorie->author;    

        $article = Article::findOrFail($id);
        $article = $article->toArray();
        $title = 'Edit Article';
        return view('admin.backend.articles.article.articleEdit', compact('article','title','contentName','contentName2','contentName3','contentName4'));
    }
