  ...
  <div class="panel-body">
      {!! Form::open(['route' => 'articles.store', 'files' => true]) !!}
        ...
        <div class="form-group">
          ...
          {!! Form::text('alias', old('alias'), ['class' => 'form-control', 'placeholder' => 'Alias Name', 'autocomplete'=> 'off']) !!}
        </div>
        <div class="form-group">
        @if ($errors->has('alias'))
          <span class="alert alert-danger">
        ...
        <div class="form-group">
          ...
          {!! Form::select('category_id',  $contentName2, array(old('category_id')), array('class' => 'form-control') ) !!}
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          {!! Form::select('content_id',  $contentName, array(old('content_id')), array('class' => 'form-control') ) !!}
        </div>
        <div class="form-group">
